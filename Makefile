...
#    Updated: 2026/05/29 17:01:55 by carlaugu         ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC      = src/main.cpp src/ConfigParser.cpp src/ConfigParserDirectives.cpp \
		src/ConfigParserUtils.cpp src/Location.cpp src/ServerConfig.cpp src/ServerManager.cpp \
		src/Client.cpp
